...
class BdWebScan {
  ...
  /**
   * Filters outgoing cookies only and not referer
   * referer header is not blocked and may be used for tracking but may be
   * blocked by the browser with a 'strict-origin-when-cross-origin' policy
   * Injects DNT header
   *
