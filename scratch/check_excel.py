...
with pd.ExcelFile(excel_path) as xl:
    for sheet in xl.sheet_names:
        ...
        # Filter rows matching Orko, Panthor, Prince Adam, Ram Man, Raphael, Panthro
        matches = df[df['Name'].str.contains('Orko|Panthor|Prince Adam|Ram Man|Raphael|Panthro', case=False, na=False)]
