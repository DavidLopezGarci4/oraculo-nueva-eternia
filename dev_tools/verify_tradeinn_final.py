...
async def verify_tradeinn_final():
    async with async_playwright() as p:
        print("🚀 Lanzando navegador para verificación final (Click Icon)...")
        ...
        print("🖱️ Haciendo click en la lupa...")
        search_icon = page.locator('#buscador_google_container img')
        ...
        try:
            ...
            await page.screenshot(path="tradeinn_verification_final_icon_success.png")
            
        except Exception as e:
            print(f"❌ FINAL: No se detectaron productos: {str(e)[:100]}")
            await page.screenshot(path="tradeinn_verification_final_icon_fail.png")
            
        await browser.close()

if __name__ == "__main__":
    asyncio.run(verify_tradeinn_final())
