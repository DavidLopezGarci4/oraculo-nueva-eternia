...
- [x] **Fase AAA: Auditoría y Elevación a Triple-A (21/07/2026)** — rama `refactor/aaa-uplift`. Reporte completo en [REPORTE_MEJORAS_AAA.md](REPORTE_MEJORAS_AAA.md).
  ...
  - [ ] Pendiente: trocear `Config.tsx`/`Purgatory.tsx`/`Catalog.tsx`, virtualizar listas largas, y que el usuario rote los secretos + aplique la migración Alembic en su despliegue real (ver `Apuntes a llevar a cabo.txt`, fuera del repo).
