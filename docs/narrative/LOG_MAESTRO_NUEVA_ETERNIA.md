...
- **Logros Técnicos**:
  ...
  - **Calibradores y Scroll Vertical**: Soporte de scroll vertical completo en calibradores de haz de luz He-Man (Espada de Poder) y calibrador de Skeletor Vintage (Espada de Skeletor, usando la imagen real GlassmorphSword.png con coordenadas horizontales centradas a 125.0) con persistencia local para evitar desbordamiento y recortes en dispositivos móviles.
