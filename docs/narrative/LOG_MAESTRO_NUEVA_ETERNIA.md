...
- **Logros Técnicos**:
  ...
  - **Optimización de Créditos y Fecha**: Añadido `"orderBy": "newest"` en la carga de Apify para priorizar anuncios recientes de Wallapop. Para búsquedas en segundo plano (query `"auto"`), se limitó el recuento de resultados de dataset a `max_items=15` por término, minimizando el cargo de créditos por evento en Apify.
