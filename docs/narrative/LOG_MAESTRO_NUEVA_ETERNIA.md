...
- **Logros Técnicos**:
  ...
  - **Playwright Interactivo de Captchas**: Implementado modo visible (`headless=False`) dinámico en Playwright local para lanzamientos directos de Wallapop. Si se topa con un bloqueo de Cloudflare WAF, el scraper aguarda hasta 20 segundos para permitir al usuario hacer clic manualmente en la ventana del navegador. Una vez resuelto, el scraper continúa de forma directa y gratuita.
