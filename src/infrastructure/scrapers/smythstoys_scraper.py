...
class SmythsToysScraper(BaseScraper):
    ...
    - OPCIÓN 1 (Activa por defecto): Playwright Headless con inyección profunda de antidetect,
      spoofing de fingerprint y simulación de comportamiento humano (scroll y esperas aleatorias).
    ...
    async def _search_option_1(self, query: str) -> List[ScrapedOffer]:
        """
        OPCIÓN 1: Playwright con evasión antidetect profunda y emulación humana.
        """
        from playwright.async_api import async_playwright
        
        self._log("🛡️ Ejecutando OPCIÓN 1: Playwright con inyección Stealth profunda")
        products: List[ScrapedOffer] = []
        seen_urls = set()
        user_agent = random.choice(self.USER_AGENTS)
        
        async with async_playwright() as p:
            # Lanzamiento de Chromium con argumentos antidetect
            ...
            await page.add_init_script("""
                ...
                // Mapear plugins falsos pero creíbles
