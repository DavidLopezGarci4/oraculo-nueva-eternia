    ...
    return (
        <div className="space-y-2 md:space-y-3 animate-in fade-in slide-in-from-bottom-4 duration-1000">
            ...
            <div className="grid grid-cols-2 gap-3 md:gap-6 md:grid-cols-3">
                <div className="group relative overflow-hidden rounded-xl md:rounded-2xl border border-white/5 bg-black/50 backdrop-blur-md p-4 md:p-5">
            ...
            {!isAdmin ? (
                ...
                <div className="space-y-4 md:space-y-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="rounded-2xl md:rounded-[2.5rem] border border-white/5 bg-black/50 backdrop-blur-md overflow-hidden">
