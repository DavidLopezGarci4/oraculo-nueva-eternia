...
import PurgatoryToolbar from '../components/purgatory/PurgatoryToolbar';
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-2 md:space-y-3 animate-in fade-in duration-700">
            <PurgatoryToolbar
                ...
                uniqueShopsInPending={uniqueShopsInPending}
                enableTransitFilter={enableTransitFilter}
                setEnableTransitFilter={setEnableTransitFilter}
