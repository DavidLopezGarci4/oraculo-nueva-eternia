        ...
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 space-y-3">
                    {items.map((item) => (
                        <div key={item.id} className="group flex items-center justify-between gap-4 p-4 rounded-[1.5rem] border border-white/5 bg-black/50 hover:bg-white/[0.04] transition-all backdrop-blur-md">
                ...
                <div className="space-y-4">
                    <div className="rounded-[2rem] border border-brand-primary/20 bg-black/50 p-6 lg:p-8 space-y-6 relative overflow-hidden backdrop-blur-xl">
