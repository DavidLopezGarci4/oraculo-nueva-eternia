    ...
    return (
        <nav className="sticky top-0 z-10 flex h-16 items-center border-b border-glass-border glass px-4 md:px-6 backdrop-blur-md gap-4">
            ...
            <div className="flex items-center gap-2 md:gap-6 shrink-0">
                ...
                <div className="flex items-center gap-3 border-l border-white/10 pl-3 md:pl-6 cursor-pointer group">
                    ...
                    <span className="hidden md:block text-sm font-medium text-white/80 group-hover:text-white transition-colors">Admin</span>
                </div>
            </div>
        </nav>
    );
